...
ModbusRTUServerClass::ModbusRTUServerClass(RS485_CLASS& rs485) : _rs485(&rs485)
{
}
...
int ModbusRTUServerClass::begin(RS485_CLASS& rs485, int id, unsigned long baudrate, uint16_t config)
{
  _rs485 = &rs485;
